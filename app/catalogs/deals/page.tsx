...
export default function DealsPage() {
  ...
  return (
    <>
      ...
      {/* Outside AppShell, deliberately.
          AppShell renders its children TWICE — a narrow layout and a wide one,
          with CSS hiding whichever does not apply. A dialog portals to the body,
          so the CSS that hides its container does not hide it: both instances
          appear, stacked, each with its own state. Keeping it out here means one
          dialog. */}
      {editing ? (
        <DealScopeDialog
          open
