  ...
  },
  {
    ...
    screens: [
      ...
      },
      {
        ...
        note: "New PIN revealed immediately with a green banner: how many terminals were signed out and the instruction to re-pair each with this PIN. The list below flips every row to Expired rather than emptying, so the banner's 'enter this PIN on each one' is answerable by looking at it. 'Demo: pair a terminal' from here reactivates an expired row and restores its name, which is the reason those rows stay visible.",
      },
      {
