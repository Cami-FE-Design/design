---
name: workflow-hypothesis-tester
description: >-
  Multi-step workflow. Investigate 5 competing hypotheses in parallel with
  supporting and disconfirming evidence. Use when: debug metrics, root cause
  analysis, hypothesis test, why did metrics drop.
category: data
---
...
**Filename:** `hypothesis-testing-report-<YYYY-MM-DD>.md`
...
>
> **Report saved to:** `work/discovery/outputs/hypothesis-testing-report-<YYYY-MM-DD>.md`
>
...
└── hypothesis-testing-report-<YYYY-MM-DD>.md
```
