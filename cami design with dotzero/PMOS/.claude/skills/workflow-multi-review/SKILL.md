---
name: workflow-multi-review
description: >-
  Multi-step workflow. Run a document past every reviewer-persona agent
  installed in this project, in parallel, and synthesize the feedback. Use
  when: review PRD, multi-perspective review, get feedback, stakeholder review.
category: operations
---
