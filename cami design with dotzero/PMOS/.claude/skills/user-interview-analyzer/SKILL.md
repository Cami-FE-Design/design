...
Write the file to exactly this path:
  ...
  work/discovery/outputs/interview-snapshot-[name]-<YYYY-MM-DD>.md
...
Have multiple transcripts? `/batch-interview-analysis` processes them all and synthesizes into personas and an opportunity tree. *(available in the full PM OS)*
