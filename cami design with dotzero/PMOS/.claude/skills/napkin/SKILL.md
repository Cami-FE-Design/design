---
name: napkin
description: "Maintain a per-repo napkin file at .claude/napkin.md that tracks mistakes, corrections, and what works. Read before doing anything, write continuously as you work."
