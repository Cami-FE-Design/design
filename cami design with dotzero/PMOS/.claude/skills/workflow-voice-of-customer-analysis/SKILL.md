---
name: workflow-voice-of-customer-analysis
description: >-
  Multi-step workflow. Synthesize feedback from multiple sources — support
  tickets, NPS, sales calls, reviews — into prioritized pain points and
  opportunities. Use when: customer feedback, VoC analysis, support ticket
  analysis.
category: discovery
---
...
| [Pain 4] | High (70+) | Low | 2/5 | Quality of life | Backlog |
```
...
**Filename:** `voc-analysis-report-<YYYY-MM-DD>.md`

**Location:** `work/discovery/outputs/`
...
>
> **Report saved to:** `work/discovery/outputs/voc-analysis-report-<YYYY-MM-DD>.md`
>
...
│   └── app-reviews.txt
└── outputs/
    └── voc-analysis-report-<YYYY-MM-DD>.md
```
