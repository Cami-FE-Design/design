---
name: workflow-market-sizing-analyzer
description: >-
  Multi-step workflow. Calculate TAM/SAM/SOM using 5 methodologies — analyst
  reports, competitor financials, bottom-up, top-down, adjacent proxies. Use
  when: market sizing, TAM analysis, TAM SAM SOM.
category: strategy
---
...
**Filename:** `market-sizing-report-<YYYY-MM-DD>.md`
...
>
> **Report saved to:** `work/strategy/outputs/market-sizing-report-<YYYY-MM-DD>.md`
>
...
└── market-sizing-report-<YYYY-MM-DD>.md
```
