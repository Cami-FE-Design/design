---
name: workflow-batch-interview-analysis
description: >-
  Multi-step workflow. Analyze batch customer interviews — snapshots, synthesis,
  personas, opportunity tree. Use when: batch interviews, analyze interviews,
...
`work/discovery/outputs/interview-snapshot-[filename]-<YYYY-MM-DD>.md`
...
**Save personas to:**
`work/discovery/outputs/personas-<YYYY-MM-DD>.md`
...
`work/discovery/outputs/opportunity-tree-<YYYY-MM-DD>.md`
...
>
> All outputs saved to `work/discovery/outputs/`
