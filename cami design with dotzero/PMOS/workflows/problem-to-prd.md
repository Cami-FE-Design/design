---
description: 'Take a problem statement through validation, scoping, and PRD generation in a single guided workflow. Use when: end-to-end PRD process, problem to PRD, complete PRD workflow.'
---
