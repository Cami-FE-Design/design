...
**Requirement detail lives in** [`work/specs/merchant-settlement-prd.md`](../merchant-settlement-prd.md) (40 `SET-` IDs, QA edge cases, written for BA/QA/eng). This document is the problem, evidence, and risk case for stakeholders. The two are deliberately not duplicated.
